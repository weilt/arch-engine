...
server.tool(
  "query_design",
  "Query project design profile: global tokens/style/bindings, page recipe (includes logicMarkdown, pageType, feature, gaps), or semantic component (component includes binding when framework-bindings.json exists)",
  {
